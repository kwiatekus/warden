...
# Expected variables:
RELEASE_ID=${RELEASE_ID?"Define RELEASE_ID env"}
...
( cd charts ; tar czf "warden-chart.tgz" warden)

uploadFile "charts/warden-chart.tgz" "${UPLOAD_URL}?name=warden-chart.tgz"
